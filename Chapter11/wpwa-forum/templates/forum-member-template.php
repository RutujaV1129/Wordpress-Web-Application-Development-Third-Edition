...
<div class='main_panel'>
    <div class='forum_member_profile_panel'>
        <h2><?php echo __('Personal Information','wpwaf'); ?></h2>
        <div class='field_label'><?php echo __('Full Name','wpwaf'); ?></div>
        <div class='field_value'><?php echo esc_html($wpwaf_topics_data['display_name']); ?></div>
        <div class='field_label'><?php echo __('Interested Topics','wpwaf'); ?></div>
        <div class='field_value'><?php echo esc_html($wpwaf_topics_data['interested_topics']); ?></div>
        <div class='field_label'><?php echo __('Skills','wpwaf'); ?></div>
        <div class='field_value'><?php echo esc_html($wpwaf_topics_data['skills']); ?></div>
        <div class='field_label'><?php echo __('Country','wpwaf'); ?></div>
        <div class='field_value'><?php echo esc_html($wpwaf_topics_data['country']); ?></div>
    </div>

    <div id='forum_member_topics'>
        <h2><?php echo __('Topics','wpwaf'); ?></h2>
        <div id="msg_container"></div>
        <?php if ($wpwaf_topics_data['forum_member_status']) {
 ?>
            <input type='button' id="wpwaf_add_topic" value="<?php echo __('Add New','wpwaf'); ?>" />
<?php } ?>
