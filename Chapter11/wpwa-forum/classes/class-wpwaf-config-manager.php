...
class WPWAF_Config_Manager{
    ...
    public function create_custom_tables(){
        ...
        if($wpdb->get_var("show tables like '$topic_replies_table'") != $topic_replies_table) {
            $sql = "CREATE TABLE $topic_replies_table (
              id mediumint(9) NOT NULL AUTO_INCREMENT,
              time datetime DEFAULT '0000-00-00 00:00:00' NOT NULL,
              user_id mediumint(9) NOT NULL,
              topic_id  mediumint(9) NOT NULL,
              topic_content  longtext NOT NULL,
              notify_status  mediumint(9) NOT NULL,
              UNIQUE KEY id (id)
            );";
            dbDelta( $sql );
        }

        $forum_users_table = $wpdb->prefix.'forum_users';       
        if($wpdb->get_var("show tables like '$forum_users_table'") != $forum_users_table) {
            $sql = "CREATE TABLE $forum_users_table (
              id mediumint(9) NOT NULL AUTO_INCREMENT,
              join_time datetime DEFAULT '0000-00-00 00:00:00' NOT NULL,
              user_id mediumint(9) NOT NULL,
