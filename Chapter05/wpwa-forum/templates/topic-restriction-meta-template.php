...
<div class="wpwaf_post_meta_row">
	<div class="wpwaf_post_meta_row_label"><strong><?php _e('Visibility','wpwaf'); ?></strong></div>
	<div class="wpwaf_post_meta_row_field">
...
<div id="wpwaf_topic_role_panel" class="wpwaf_post_meta_row" <?php echo $show_role_field; ?> >
	<div class="wpwaf_post_meta_row_label"><strong><?php _e('Allowed User Roles','wpwaf'); ?></strong></div>
	<div class="wpwaf_post_meta_row_field">
...
<div class="wpwaf_post_meta_row">
	<div class="wpwaf_post_meta_row_label"><strong><?php _e('Redirection URL','wpwaf'); ?></strong></div>
	<div class="wpwaf_post_meta_row_field">
